---
title: "Advanced Git: achieving utopic git history"
format:
  revealjs:
    slide-number: true
...
## Best practice: feature branches {.smaller}
...
## Best practice: atomic commits {.smaller}
...
<img src="https://leonardomontini.dev/_astro/_merge-settings.DL673XTF_ZR6yTX.webp" />
...
## A note on merge conflicts {.smaller}
...
## How to achieve atomic commits {.smaller}
...
Exercises at: https://github.com/UtrechtUniversity/progcafe-advanced-git/exercises
